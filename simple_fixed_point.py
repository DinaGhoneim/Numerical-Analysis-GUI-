...
def simple_fixed_point():
    ...
    label = CTkLabel(master=window, text="Simple Fixed Point Method", font=("Times New Roman", 50),
    ...
    table = CTkTable(master=frameT, column=4, fg_color="#00246B")
    ...
    def insert_data():
        ...
        if switch.get() == 1:
            ...
            while i <= et:
                ...
                i += 1
            tk.messagebox.showinfo("Solution", f"The Root= {round(xxi, 3)}")
        else:
